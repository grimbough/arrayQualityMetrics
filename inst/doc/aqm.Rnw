...
@ 
%
Finally, the slot \Robject{description} contains a textual description
of the definition of \Robject{statistic} and indicates how
\Robject{threshold} was chosen. 
